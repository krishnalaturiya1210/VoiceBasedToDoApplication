...
if joblib_load is not None:
    try:
        ...
        print("Loaded intent_model.joblib in app.py")
...
# --- Database setup ---
# Use Postgres on platform (DATABASE_URL), fall back to local SQLite for dev.
basedir = os.path.abspath(os.path.dirname(__file__))

db_url = os.environ.get("DATABASE_URL")

# Some platforms give postgres://, but SQLAlchemy expects postgresql://
...
if __name__ == "__main__":
    # Railway / Render / local: use PORT env var if available
